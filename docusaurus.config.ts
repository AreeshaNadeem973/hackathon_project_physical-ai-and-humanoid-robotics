...
const config: Config = {
  ...
  organizationName: 'Areesha Nadeem',
  ...
  customFields: {
    apiUrl: process.env.REACT_APP_API_URL || 'web-production-eb560.up.railway.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/AreeshaNadeem973',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/AreeshaNadeem973',
          label: 'GitHub',
          position: 'right',
        },
      ],
